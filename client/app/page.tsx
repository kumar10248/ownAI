  ...
  return (
    <div className="flex h-screen bg-black overflow-hidden">
      ...
      <div className="flex flex-col w-full max-w-6xl mx-auto relative z-10 h-screen">
        {/* Header */}
        <header className="flex items-center justify-between p-4 sm:p-6 backdrop-blur-xl bg-white/5 border-b border-amber-500/20 shadow-lg shrink-0">
          <div className="flex items-center gap-3 sm:gap-4 min-w-0">
            <div className="relative shrink-0">
              <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-2xl bg-linear-to-br from-amber-400 to-amber-600 flex items-center justify-center shadow-lg transform active:scale-95 transition-transform">
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs sm:text-sm text-amber-200 flex items-center gap-1">
                ...
                <span className="truncate">{selectedModel === 'claude' ? 'Claude AI' : 'Gemini AI'}</span>
              </p>
            </div>
          </div>
          <div className="flex items-center gap-2 sm:gap-3 shrink-0">
            ...
            <div className="flex gap-1 sm:gap-2 bg-white/5 rounded-xl p-1 border border-amber-500/30">
              <button
                ...
                className={`px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium rounded-lg transition-all active:scale-95 touch-manipulation ${
            ...
            {messages.length > 0 && (
              <>
                <span className="text-xs sm:text-sm text-amber-200 hidden lg:inline whitespace-nowrap">
                  {messages.length} message{messages.length !== 1 ? 's' : ''}
                </span>
                <button
                  onClick={clearChat}
                  className="px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium text-white hover:text-amber-400 bg-white/5 hover:bg-white/10 rounded-xl transition-all active:scale-95 backdrop-blur-sm border border-amber-500/30 hover:border-amber-500/50 touch-manipulation"
                >
          ...
          {messages.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full text-center space-y-6 sm:space-y-8 py-8 sm:py-12 animate-fade-in px-4">
              ...
              <div className="space-y-2 sm:space-y-3">
                ...
                <p className="text-sm sm:text-lg text-amber-200 max-w-md px-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 max-w-2xl w-full mt-6 sm:mt-8 px-4">
                {suggestedPrompts.map((prompt, idx) => (
                  <button
                    ...
                    className="group p-4 text-left bg-white/5 backdrop-blur-md border border-amber-500/30 rounded-2xl hover:bg-amber-500/10 hover:border-amber-500/50 transition-all transform active:scale-95 hover:shadow-xl touch-manipulation"
                  >
                    <span className="text-xl sm:text-2xl mb-2 block">{prompt.icon}</span>
                    <span className="text-xs sm:text-sm text-white/80 group-hover:text-white line-clamp-2">
                      {prompt.text}
                    </span>
                  </button>
                ))}
        ...
        {/* Input Area */}
        <div className="p-4 sm:p-6 backdrop-blur-xl bg-white/5 border-t border-amber-500/20 shrink-0">
          <form onSubmit={sendMessage} className="flex gap-2 sm:gap-3 items-end">
            <div className="flex-1 relative">
              <textarea
                ...
                disabled={isLoading}
                rows={1}
                className="w-full px-4 py-3 sm:py-4 bg-white/5 backdrop-blur-md border border-amber-500/30 rounded-2xl focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent disabled:opacity-50 text-white placeholder-amber-300/50 resize-none transition-all text-sm sm:text-base touch-manipulation"
            ...
            <button
              ...
              className={`px-4 sm:px-8 py-3 sm:py-4 rounded-2xl font-semibold transition-all transform active:scale-95 shadow-lg flex items-center justify-center gap-2 text-sm sm:text-base min-w-[48px] touch-manipulation ${
                isLoading 
          ...
          <p className="text-[10px] sm:text-xs text-amber-300 mt-2 sm:mt-3 text-center hidden sm:block">
